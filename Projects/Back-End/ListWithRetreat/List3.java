...
public class List3<T> extends ListSecondary<T> {
    ...
    private void createNewRep() {
        ...
        //initialize all values of new representation
    ...
    public final void addRightFront(T x) {
        ...
        //create a new node and set up the values
        Node newNode = new Node();
        Node lastLeft = this.lastLeft;
        Node next = lastLeft.next;
        newNode.data = x;
        newNode.next = next;
        newNode.previous = lastLeft;
    ...
    public final T removeRightFront() {
        ...
        //set all values to remove the right front value
        Node lastLeft = this.lastLeft;
        Node first = lastLeft.next;
        Node second = first.next;
        T pastData = first.data;
        lastLeft.next = second;
        second.previous = lastLeft;
        ...
        //return the value of right front
        return pastData;
    }
    ...
    public final void advance() {
        ...
        // moving last node ahead a position
        this.lastLeft = this.lastLeft.next;
        //increasing length of left and decreasing right length
        this.leftLength++;
        this.rightLength--;
    ...
    public final void moveToStart() {
        //bringing position back to the start node
        this.lastLeft = this.preStart;
        //combining lengths to restart
        this.rightLength += this.leftLength;
        //clearing left length
        this.leftLength = 0;
    ...
    public final void moveToFinish() {
        ...
        //sets position to last node
        this.lastLeft = this.postFinish.previous;
        //moves all of length to left since position is last node
    ...
    public final void retreat() {
        ...
        //sets position backwards one
        this.lastLeft = this.lastLeft.previous;
        //decreases length of left and increases right length
        this.leftLength--;
        this.rightLength++;
