...
public abstract class ListTest {
   ...
   // TODO - add test cases for retreat
    ...
    @Test
    public final void testRetreatLeftNonEmptyRightTwo() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(2, "green", "red", "blue");
        List<String> list2 = this.createFromArgsRef(1, "green", "red", "blue");
        /*
         * Call method under test
         */
    ...
    @Test
    public final void testRetreatLeftUntilEmptyRightNonEmpty() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(4, "yellow", "orange",
