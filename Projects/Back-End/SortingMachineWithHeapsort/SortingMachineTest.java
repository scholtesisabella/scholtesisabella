...
public abstract class SortingMachineTest {
    ...
    @Test
    public final void testAddWithManyElements() {
        /*
         * Set up variables
         */
    ...
    @Test
    public final void removeFirstOneElement() {
        /*
         * Set up variables
         */
    ...
    @Test
    public final void removeFirstOneUntilEmpty() {
        /*
         * Set up variables
         */
        SortingMachine<String> m = this.createFromArgsTest(ORDER, false,
         ...
         * Call method under test
         */
        String removedOne = m.removeFirst();
        String removedTwo = m.removeFirst();
        String removedThree = m.removeFirst();
        String removedFour = m.removeFirst();

        /*
         * Assert that values of variables match expectations
         */
        assertEquals(mExpected, m);
        assertEquals(removedOne, "blue");
        assertEquals(removedTwo, "green");
        assertEquals(removedThree, "red");
        assertEquals(removedFour, "yellow");
    }

    @Test
    public final void removeFirstElementMany() {
        /*
         * Set up variables
         */
        SortingMachine<String> m = this.createFromArgsTest(ORDER, false,
    ...
    public final void orderTest() {
        ...
        Comparator<String> orderTest = m.order();
